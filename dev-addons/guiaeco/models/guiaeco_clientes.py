...
class GuiaecoClientes(models.Model):
    ...
    imagenPlaca = fields.Char(string='Imagen placa cliente')
    cabecera = fields.Char(string='Cabecera cliente')
    ...
    calidadBeneficios = fields.Integer(string='Beneficios importantes para usted y su negocio')
